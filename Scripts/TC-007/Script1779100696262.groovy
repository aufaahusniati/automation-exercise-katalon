...
WebUI.verifyElementPresent(findTestObject('Page_Automation Exercise - All Products/h2_Searched Products'), 0)

WebUI.verifyElementPresent(findTestObject('Page_Automation Exercise - All Products/div_Rs. 500_2'), 0)
