...
WebUI.verifyElementVisible(findTestObject('Page_Automation Exercise - All Products/a_Logged in as Aufaa'))
...
WebUI.setText(findTestObject('Page_Automation Exercise - Checkout/textarea_message'), 'yes')
...
WebUI.click(findTestObject('Page_Automation Exercise - Payment/h2_Payment'))

WebUI.setText(findTestObject('Page_Automation Exercise - Payment/input_name_on_card'), 'aufaa')

WebUI.setText(findTestObject('Page_Automation Exercise - Payment/input_card_number'), '12345678')

WebUI.setText(findTestObject('Page_Automation Exercise - Payment/input_ex. 311'), '211')

WebUI.setText(findTestObject('Page_Automation Exercise - Payment/input_MM'), '11')

WebUI.setText(findTestObject('Page_Automation Exercise - Payment/input_YYYY'), '2111')
