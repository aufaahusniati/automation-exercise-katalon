...
WebUI.setText(findTestObject('Page_Automation Exercise - Signup  Login/input_Email_Login'), 'aufaasuite001@gmail.com')
...
WebUI.verifyElementVisible(findTestObject('Page_Automation Exercise - Signup  Login/p_Your email or password is incorrect'))
