...
WebUI.waitForElementVisible(findTestObject('Page_Automation Exercise - All Products/button_Continue Shopping'), 3)
...
WebUI.click(findTestObject('Page_Automation Exercise - Checkout/a_cart_quantity_delete'))

WebUI.verifyElementVisible(findTestObject('Page_Automation Exercise - Checkout/span_empty_cart'))
