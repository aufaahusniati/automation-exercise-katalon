...
WebUI.setText(findTestObject('Page_Automation Exercise - Signup  Login/input_Name_Signup'), 'hiuuuuuu')
...
WebUI.click(findTestObject('Page_Automation Exercise - Signup  Login/p_Email Address already exist'))
